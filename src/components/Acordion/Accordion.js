...
const Accordion = () => {
  ...
  return (
    <div className="h-20 w-full bg-[#F1F5FD] dark:bg-[#3339CD] rounded-md p-6">
      <div className="flex flex-row">
        ...
        <h3 className="font-bold text-xl font flex-1 w-5/6 text-left text-[#4B50BA] leading-[26px] pl-8  ">
          Time
        </h3>
        <span
      ...
      {open && (
        <div className="mt-16 w-full pl-32">
          <DisplayCheckbox />
        </div>
      )}
    </div>
